...
const Form = () => {
    ...
    return (
	    ...
	    <form onSubmit={(e) => e.preventDefault()}>
			...
			<select onMouseDown={consultNormalSelectData} onChange={(e) => printValue(e.target)} id="normalSelect" name='country'>
		    ...
		    <FinderSelect data={finderSelectData} label='name' value='alpha2Code' onClick={consultFinderSelectData} onChange={printValue} name='country' placeholder='Select a country' extraInfo='capital' />
                </div>
            </form>
